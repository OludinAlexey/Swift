...
class ViewController: UIViewController {
    ...
    let correctLogin: String = "Administrator"
    let correctPassword: String = "12345"
    ...
    @IBAction func didLoginButtonTouch(_ sender: UIButton) {
        ...
        authentication(login: login, password: password) ? print("Correct login! You has entered the Matrix!") : print("Incorrect login. You`ll never get into the Matrix! Ha-ha-ha!!!")
    }
